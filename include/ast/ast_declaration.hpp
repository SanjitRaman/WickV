...
public:
    Declaration(Node *declaration_specifiers, NodeList *init_declaration_list=nullptr) : declaration_specifiers_(declaration_specifiers), init_declaration_list_(init_declaration_list){};
    virtual ~Declaration()
    {
