...
public:
    FunctionCall(Node *postfix_expression, NodeList *argument_expression_list) : postfix_expression_(postfix_expression), argument_expression_list_(argument_expression_list){};
    FunctionCall(Node *postfix_expression) : postfix_expression_(postfix_expression), argument_expression_list_(nullptr){};
