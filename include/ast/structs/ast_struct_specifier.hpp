...
class StructSpecifier : public Node
{
   private:
    ...
    Node *struct_declaration_list_;

   public:
    StructSpecifier(std::string identifier , Node *struct_declaration_list) : identifier_(identifier), struct_declaration_list_(struct_declaration_list){};
