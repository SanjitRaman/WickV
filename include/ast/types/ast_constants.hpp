...
class IntConstant : public Node
{
   ...
   public:
    ...
    int getValue() const override; //Can define a union / struct for this return type and the relevant value is accessed?
...
class FloatConstant : public Node
{
    ...
    public:
        ...
        int getValue() const override; //TODO: Implement a float getValue in node and here
        virtual std::string getId() const override;
